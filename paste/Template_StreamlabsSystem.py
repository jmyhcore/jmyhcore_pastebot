...
from GenPasta import GenPasta
#---------------------------
#   [Required] Script Information
#---------------------------
ScriptName = "Pasta"
Website = "https://www.streamlabs.com"
Description = "!send random pasta in chat"
Creator = "jmyhcore"
Version = "1.0.0.0"
...
ScriptSettings = GenPasta()

#---------------------------
#   [Required] Initialize Data (Only called on load)
#---------------------------
def Init():
    Parent.SendStreamMessage('asdasd')
    ...
    ScriptSettings = GenPasta(SettingsFile)
...
def Execute(data):
    ...
    if data.IsChatMessage() and data.GetParam(0).lower() == ScriptSettings.Command and not Parent.IsOnUserCooldown(ScriptName,ScriptSettings.Command,data.User) and Parent.HasPermission(data.User,ScriptSettings.Permission,ScriptSettings.Info):
        ...
        Parent.SendStreamMessage(ScriptSettings.generate())    # Send your message to chat
